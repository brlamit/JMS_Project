...
Public Class ItemViewForm
    Private Sub ItemViewForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'JMSDataSet5.JunkData' table. You can move, or remove it, as needed.
        Me.JunkDataTableAdapter.Fill(Me.JMSDataSet5.JunkData)
